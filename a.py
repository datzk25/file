...
class GETTOKEN:
    ...
    def run(self):
        ...
        console.print(
            """
        [sky_blue2][[cyan3] 01 [sky_blue2]] [yellow2]>> [medium_spring_green]FACEBOOK FOR ANDROID[/]

        [sky_blue2][[cyan3] 02 [sky_blue2]] [yellow2]>> [medium_spring_green]FACEBOOK MESSENGER FOR ANDROID[/]

        [sky_blue2][[cyan3] 03 [sky_blue2]] [yellow2]>> [medium_spring_green]FACEBOOK FOR IPHONE[/]

        [sky_blue2][[cyan3] 04 [sky_blue2]] [yellow2]>> [medium_spring_green]FACEBOOK MESSENGER FOR IPHONE[/]

        [sky_blue2][[cyan3] 05 [sky_blue2]] [yellow2]>> [medium_spring_green]FACEBOOK FOR LITE[/]

        [sky_blue2][[cyan3] 06 [sky_blue2]] [yellow2]>> [medium_spring_green]FACEBOOK MESSENGER FOR LITE[/]

        [sky_blue2][[cyan3] 07 [sky_blue2]] [yellow2]>> [medium_spring_green]ADS MANAGER APP FOR ANDROID[/]

        [sky_blue2][[cyan3] 08 [sky_blue2]] [yellow2]>> [medium_spring_green]ADS MANAGER APP FOR IOS[/]

        [sky_blue2][[cyan3] 09 [sky_blue2]] [yellow2]>> [medium_spring_green]FACEBOOK MESSENGER FOR IPHONE DEV[/]

        [sky_blue2][[cyan3] 10 [sky_blue2]] [yellow2]>> [medium_spring_green]PAGES MANAGER FOR IOS[/]

        [sky_blue2][[cyan3] 11 [sky_blue2]] [yellow2]>> [medium_spring_green]PAGES MANAGER FOR ANDROID[/]

        [sky_blue2][[cyan3] 12 [sky_blue2]] [yellow2]>> [medium_spring_green]PAGES MANAGER FOR WINDOWS[/]

        [sky_blue2][[cyan3] 13 [sky_blue2]] [yellow2]>> [medium_spring_green]BUSINESS MANAGER[/]

        [sky_blue2][[cyan3] 14 [sky_blue2]] [yellow2]>> [medium_spring_green]MESSENGER KIDS FOR IOS[/]

        [sky_blue2][[cyan3] 15 [sky_blue2]] [yellow2]>> [medium_spring_green]MESSENGER FOR IOS (IN-HOUSE)[/]

        [sky_blue2][[cyan3] 16 [sky_blue2]] [yellow2]>> [medium_spring_green]FACEBOOK FOR IPAD[/]
        """
        )
        app_id = ''
        ...
        print(url,file = open('test.txt','w'))
        print('\n')
